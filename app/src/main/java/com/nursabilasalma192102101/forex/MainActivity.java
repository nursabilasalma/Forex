package com.nursabilasalma192102101.forex;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initForex() {
        ...
        String url = "https://openexchangerates.org/api/latest.json?app_id=8397c2a0ba4f4fd9b90999dd707bb9ba";

        AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
        asyncHttpClient.get(url, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responsBody) {
                Gson gson = new Gson();
                RootModel rootModel = gson.fromJson(new String(responsBody), RootModel.class);
